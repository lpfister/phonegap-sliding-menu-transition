/*
 ...
 API cleaned up and improved by Andreas Sommer (https://github.com/AndiDog/phonegap-ios-SlidingMenu-plugin).
 */
 ...
 */
SlidingMenu.prototype.create = function(options) {
    cordova.exec("SlidingMenu.create", options || {});
};

/**
 * Create a new tab bar item for use on a previously created tab bar.  Use ::showSlidingMenuItems to show the new item on the tab bar.
 *
 ...
 */
SlidingMenu.prototype.createItem = function(label, image, section, options) {
  	var tag = this.tag++;
    ...
    cordova.exec("SlidingMenu.createItem", label, image, section, options);
};
 ...
 * @see showItems
 */
SlidingMenu.prototype.getSelectedItem = function() {
 ...
 */
SlidingMenu.prototype.hide = function(animate) {
    if (animate === undefined || animate === null)
        animate = true;
    cordova.exec("SlidingMenu.hide", {animate: animate});
};
 ...
 */
SlidingMenu.prototype.onItemSelected = function(tag)
{
...
SlidingMenu.prototype.resize = function() {
    cordova.exec("SlidingMenu.resize");
};
 ...
 * @see showItems
 */
SlidingMenu.prototype.selectItem = function(tab) {
    cordova.exec("SlidingMenu.selectItem", tab);
};
 ...
 */
SlidingMenu.prototype.show = function(options) {
    cordova.exec("SlidingMenu.show", options || {});
};
 ...
 * @see create
 */
SlidingMenu.prototype.showItems = function() {
    var parameters = [ "SlidingMenu.showItems" ];
 ...
 *  - \c badge value to display in the optional circular badge on the item; if null or unspecified, the badge will be hidden
 */
SlidingMenu.prototype.updateItem = function(name, options) {
    if (!options) options = {};
    cordova.exec("SlidingMenu.updateItem", name, options);
};

/*loic to be remove*/
SlidingMenu.prototype.slide = function(name, options) {
    if (!options) options = {};
    cordova.exec("SlidingMenu.slide", name, options);
};
/*end loic*/


/*loic to be remove*/
SlidingMenu.prototype.showLeftMenu = function(name, options) {
    if (!options) options = {};
    cordova.exec("SlidingMenu.showLeftMenu", name, options);
};
SlidingMenu.prototype.pushView = function(name, options) {
    if (!options) options = {};
    cordova.exec("SlidingMenu.pushView", name, options);
};
SlidingMenu.prototype.startTrans = function(name, options) {
    if (!options) options = {};
    cordova.exec("SlidingMenu.startTrans", name, options);
};
/*end loic*/
...
cordova.addConstructor(function()
                       ...
                       window.plugins.SlidingMenu = new SlidingMenu();
                       });
